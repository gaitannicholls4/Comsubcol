...
<?php } 
wp_enqueue_script( 'wdm-prv-msg',plugin_dir_url( __FILE__ ) . 'ajax-actions/send-private-best-offer.js');
wp_localize_script('wdm-prv-msg', 'uaprvobj', array('ajaxurl' => admin_url('admin-ajax.php'),
                                                                                                  'img_url' => plugin_dir_url( __FILE__ ) .'img/ajax-loader.gif',
                                                                                                  'name_msg' => __("Please enter your Name", "wdm-ultimate-auction"),
                                                                                                  'email_msg' => __("Please enter your Email address", "wdm-ultimate-auction"),
                                                                                                  'email_valid_msg' => __("Please enter a valid Email address", "wdm-ultimate-auction"),
                                                                                                   'empty_msg' =>  __("Please enter a message", "wdm-ultimate-auction"),
                                                                                                  'prv_send_msg' => __ ('Sending', 'wdm-ultimate-auction'),
                                                                                                  'prv_success_msg' => __("Send", "wdm-ultimate-auction"),
                                                                                                  'offer_amt_msg' => __("Please enter your Offer Amount", "wdm-ultimate-auction"),
                                                                                                  'numeric_msg' => __("Please enter a numeric value", "wdm-ultimate-auction"),
                                                                                                 'greater_msg' => __("Please enter a value greater than 0.", "wdm-ultimate-auction"),
                                                                                                  'auc_id' => $wdm_auction->ID,
                                                                                                  'author_email' => $auction_author_email,
                                                                                                  'os_id' => $auction_bidder_id
                                                                                                      ) );
