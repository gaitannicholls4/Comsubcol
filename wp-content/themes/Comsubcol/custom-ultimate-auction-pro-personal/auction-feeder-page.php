...
// 	$ua_auction_array = get_posts($args); // to be removed
		...
		if(empty($wdm_auction_array)){
			...
			<li class="wdm-apbid auc_single_list auc_list_center">
			 <?php if(isset($_GET['listing']) && $_GET['listing'] == 'sold'){
				...
				?>
				<input class="wdm_bid_now_btn wdm_auc_mid" type="button" value="<?php (empty($ob) && !empty($bnp)) ? _e('Buy Now', 'wdm-ultimate-auction'): _e('Bid Now', 'wdm-ultimate-auction') ;?>" />  
